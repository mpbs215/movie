							  ...
							  <ul>
								...
								<table class="table table-hover">
									...
									<c:forEach items="request.list" var="movie">
										<tr>
											<td contenteditable="true">${movie.movieNo}</td>
											<td contenteditable="true">${movie.title}</td>
											<td contenteditable="true">${movie.titleEnglish}</td>
											<td contenteditable="true">${movie.director}</td>
											<td contenteditable="true">${movie.actor}</td>
											<td contenteditable="true">${movie.releasedate}</td>
