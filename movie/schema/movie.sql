...
CREATE TABLE screen_info (
	...
	screen_time interval day to second NOT NULL, /* 상영시간 */
...
/* 이벤트페이지 */
CREATE TABLE event (
	event_num NUMBER NOT NULL, /* 이벤트글번호 */
...
CREATE TABLE board (
	...
	board_conts VARCHAR2(1000) NOT NULL, /* 글내용 */
...
insert into movie_info values('movie-100', '어벤져스:인피니티 워', 'Avengers: Infinity War', '안소니 루소조 루소', '로버트 다우니 주니어|톰 홀랜드|크리스 헴스워스','2018-04-25',9.02,'null',0);
insert into movie_info values('movie-200', '챔피언', 'Champion', '김용완', '마동석|권율|한예리|','2018-05-01',0.00,'http://imgmovie.naver.com/mdi/mit110/1693/169347_P41_140014.jpg',0);
insert into movie_info values('movie-300', '얼리맨', 'Early Man', '닉 파크|', '에디 레드메인|톰 히들스턴|메이지 윌리암스|','2018-05-03',8.85,'http://imgmovie.naver.com/mdi/mit110/1542/154251_P17_113702.jpg',1);
...
--------------screen_info----------------
insert into screen_info values('screen-100', 'movie-100', 'A관', '2018-05-01', '0 07:00:00', 30);
insert into screen_info values('screen-200', 'movie-200', 'B관', '2018-05-02', '0 21:00:00', 50);
insert into screen_info values('screen-300', 'movie-300', 'C관', '2018-05-03', '0 15:00:00', 100);
...
CREATE TABLE screen_info (
	...
	theater_name VARCHAR2(20) NOT NULL, /* 상영관이름 */
	screen_date DATE NOT NULL, /* 영화상영날짜 */
	screen_time NUMBER NOT NULL, /* 상영시간 */
	rev_total NUMBER NOT NULL /* 총예매수 */
);
...
select * from BOARD;
select * from EVENT;
>>>>>>> branch 'master' of https://github.com/mpbs215/movie.git
