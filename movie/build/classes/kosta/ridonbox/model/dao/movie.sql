...
insert into movie_info values('movie-100', '어벤져스:인피니티 워', 'Avengers: Infinity War', '안소니 루소조 루소', '로버트 다우니 주니어|톰 홀랜드|크리스 헴스워스','2018-04-25',9.02,'aa','null',0);
insert into movie_info values('movie-200', '챔피언', 'Champion', '김용완', '마동석|권율|한예리|','2018-05-01',0.00,'bb','http://imgmovie.naver.com/mdi/mit110/1693/169347_P41_140014.jpg',0);
insert into movie_info values('movie-300', '얼리맨', 'Early Man', '닉 파크|', '에디 레드메인|톰 히들스턴|메이지 윌리암스|','2018-05-03',8.85,'cc','http://imgmovie.naver.com/mdi/mit110/1542/154251_P17_113702.jpg',1);
