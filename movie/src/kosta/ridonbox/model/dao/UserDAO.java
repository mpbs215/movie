...
public interface UserDAO {
	...
	/**
	 * 사용자(고객) 회원가입
	 * @param MemberDTO (memberId, memberPwd, email, phone, joinDate)
	 * @return int : 1 이상이면 성공, 0이면 실패
	 */
	 ...
	 * @throws SQLException
	 */
	public MyPageDTO myPageByMember(String id)  throws SQLException;
	 ...
	 * @throws SQLException
	 */
	public MyPageDTO myPageByMemberUpdate(MyPageDTO myPageDTO)  throws SQLException;
	 ...
	 * @throws SQLException
	 */
	public List<MyPageDTO> myPageByMemberBooking(String id)  throws SQLException;
}
